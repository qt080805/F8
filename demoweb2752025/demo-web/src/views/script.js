...
// Lấy tham chiếu đến các phần tử HTML (nếu bạn đặt script ở trang header)
...
function handleSearch() {
    ...
    if (searchTerm) {
        ...
        // Hoặc bạn có thể chọn không làm gì cả
    }
}
...
// Gắn sự kiện keyup cho ô input tìm kiếm (tùy chọn: tìm kiếm khi người dùng gõ)
if (searchInput) {
...
function handleSearch() {
    ...
    if (searchTerm) {
        ...
        searchResultsContainer.innerHTML = '<p>Vui lòng nhập tên sản phẩm để tìm kiếm.</p>';
        // Hoặc bạn có thể chọn hiển thị lại tất cả sản phẩm ở đây nếu cần
